<!-- AUTO-GENERATED by prompt-build.py @ v72c0436c -->
<!-- 源文件: .prompt-src/prompt-base.md + v9-compliance-block.md + agents/qingmeisu.delta.md -->
...
```
1. 亮灯：更新 02-项目管理/智能体状态/青霉素.md — status -> busy
   追加事件：02-项目管理/智能体状态/智能体事件.jsonl
   {"ts":"ISO","event":"task_start","agent":"qingmeisu","task_id":"T-YYYYMMDD-NN","task":"任务名","task_size":"S|M|L"}
