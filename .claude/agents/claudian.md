<!-- AUTO-GENERATED by prompt-build.py @ vbb733c4b -->
<!-- 源文件: .prompt-src/prompt-base.md + v9-compliance-block.md + agents/claudian.delta.md -->
...
```
1. 亮灯：更新 02-项目管理/智能体状态/Claudian.md — status -> busy
   追加事件：02-项目管理/智能体状态/智能体事件.jsonl
   {"ts":"ISO","event":"task_start","agent":"claudian","task_id":"T-YYYYMMDD-NN","task":"任务名","task_size":"S|M|L"}
...
## 可写路径
.standards/ / .claude/ / 02-项目管理/ / 50-经验/Agent协作方法论/ / 10-项目/迭代/ / 10-项目/基线/（仅封版归集或明确授权） / _temp/
