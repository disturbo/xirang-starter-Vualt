<!-- AUTO-GENERATED by prompt-build.py @ v8d752294 -->
<!-- 源文件: .prompt-src/prompt-base.md + v9-compliance-block.md + agents/workbuddy.delta.md -->
...
```
1. 亮灯：更新 02-项目管理/智能体状态/WorkBuddy.md — status -> busy
   追加事件：02-项目管理/智能体状态/智能体事件.jsonl
   {"ts":"ISO","event":"task_start","agent":"workbuddy","task_id":"T-YYYYMMDD-NN","task":"任务名","task_size":"S|M|L"}
