...
<mxCell id="title-bg" value=""
  style="rounded=1;whiteSpace=wrap;html=1;fillColor=#2563EB;strokeColor=#1D4ED8;arcSize=6;"
  parent="1" vertex="1">
...
|------|---------------------|------|
| **start** | `rounded=1;whiteSpace=wrap;html=1;fillColor=#2563EB;fontColor=#ffffff;strokeColor=#1D4ED8;arcSize=50;fontSize=12` | 100x36 |
...
| **core** | `rounded=1;whiteSpace=wrap;html=1;fillColor=#2563EB;fontColor=#ffffff;strokeColor=#1D4ED8;arcSize=6;fontSize=12` | 120x50 |
| **normal** | `rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#2563EB;fontColor=#1A1A1A;arcSize=6;fontSize=12` | 120x50 |
...
|-----------|---------|-----|
| **primary** | 经销商/门店/SA/主管 | `fillColor=#FFF7F0;strokeColor=#2563EB;fontColor=#2563EB` |
| **system** | 业务系统/核心系统 | `fillColor=#E3F2FD;strokeColor=#1565C0;fontColor=#1565C0` |
...
| **customer** | 客户/用户/APP | `fillColor=#FFF7F0;strokeColor=#2563EB;fontColor=#2563EB` |
...
<mxGraphModel dx="1400" dy="800" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1400" pageHeight="800" math="0" shadow="0">
  <root>
    ...
    <!-- 标题栏 -->
    <mxCell id="title-bg" value="" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#2563EB;strokeColor=#1D4ED8;arcSize=6;" parent="1" vertex="1">
    ...
    <!-- 泳道 1: primary -->
    <mxCell id="lane-1" value="角色A" style="swimlane;horizontal=0;startSize=60;fillColor=#FFF7F0;strokeColor=#2563EB;fontColor=#2563EB;rounded=0;fontSize=14;fontStyle=1" parent="1" vertex="1">
    ...
    <mxCell id="n-start" value="开始" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#2563EB;fontColor=#ffffff;strokeColor=#1D4ED8;arcSize=50;fontSize=12" parent="lane-1" vertex="1">
...
<mxGraphModel dx="600" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="600" pageHeight="900" math="0" shadow="0">
  <root>
    ...
    <mxCell id="n-s1" value="状态1" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#2563EB;fontColor=#ffffff;strokeColor=#1D4ED8;arcSize=50;fontSize=12" parent="1" vertex="1">
