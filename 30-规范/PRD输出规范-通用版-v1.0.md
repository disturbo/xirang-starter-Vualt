...
source: 基于"{项目名} 项目 PRD 输出规范 v2.2"抽离方法论而成
aliases: [PRD输出规范, PRD输出规范-v2.2, {项目}项目-PRD输出规范]
---
...
| 日期 | 版本 | 变更内容 | 编写人 |
|---|---|---|---|
| 2026-05-14 | v1.0 | 基于"{项目名} PRD 输出规范 v2.2"抽离方法论，输出对外通用版。<br>**保留**：版本管理 / 章节骨架 / 7段式功能说明 / 状态机双段 / 单元格标记体系 / 字段命名 / 交互说明结构化模板 / 评审 Checklist<br>**剥离**：{项目品牌}/{产品代号}/行业缩写等项目字眼 / 18位编码业务映射表 / 项目专属角色名 / 文件路径硬编码<br>**新增**：§1.3 定制指引、§6 项目专属约束扩展点、§8 特殊形态 PRD 子规范 | 阿莫西林 |
