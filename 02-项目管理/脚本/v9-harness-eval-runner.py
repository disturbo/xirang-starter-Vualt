...
def case_phase_h_positive_long_session_stability() -> EvalResult:
    ...
    passed = proc.returncode == 0 and "Ran 16 tests" in proc.stderr and "OK" in proc.stderr
    return EvalResult(
        ...
        "16/16 Phase H long-session tests passed" if passed else "Phase H regression suite failed",
        {"returncode": proc.returncode, "stdout": proc.stdout[-500:], "stderr": proc.stderr[-1000:]},
    )
